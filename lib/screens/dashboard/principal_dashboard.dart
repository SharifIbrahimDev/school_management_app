...
class PrincipalDashboard extends StatefulWidget {
  ...
  const PrincipalDashboard({super.key, required this.schoolId});
...
class _PrincipalDashboardState extends State<PrincipalDashboard> {
  ...
  Future<void> _loadPrincipalAnalytics(String sectionId) async {
    try {
      ...
      debugPrint('Error loading principal analytics: $e');
    }
  }
  ...
  Future<void> _loadStats() async {
    ...
    try {
      ...
      await _loadPrincipalAnalytics(_selectedSectionId!);
    } catch (e) {
