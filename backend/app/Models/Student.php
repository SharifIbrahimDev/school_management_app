...
class Student extends Model
{
    ...
    protected static function booted()
    {
        static::creating(function ($student) {
            ...
            // Remove section_id from attributes if generated by factories or legacy code
            if (array_key_exists('section_id', $student->getAttributes())) {
                $student->temp_section_id = $student->getAttribute('section_id');
                unset($student->attributes['section_id']);
            }
        });

        static::created(function ($student) {
            if ($student->temp_section_id) {
                $student->sections()->syncWithoutDetaching([$student->temp_section_id]);
            } elseif ($student->classModel && $student->classModel->section_id) {
                $student->sections()->syncWithoutDetaching([$student->classModel->section_id]);
            }
        });
    }
}
